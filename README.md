...
## Objetivos
- Entender como sistemas computacionais funcionam por dentro usando circuitos lógicos
- Aplicar conceitos de representação e manipulação de dados em baixo nível
- Simular componentes de processadores 
- Desenvolver habilidades de modelagem e simulação com o Logisim
...
2. Abra o projeto desejado no Logisim
3. Execute o projeto
...
`Calculadora`: Implementação de operações aritméticas básicas utilizando circuitos lógicos
...
`MuxDemux`: Implementação de multiplexador e demultiplexador para controle de fluxo de dados
